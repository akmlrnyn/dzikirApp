package com.nyan.doadzikirapp.model
...
object DataDoaDzikir {
    ...
    private val translateQauliyah = arrayOf(
        ...
        val listQauliyah: ArrayList<DoaDzikirItem>
            get() {
    ...
    fun listDzikir(): List<DoaDzikirItem> {
        //to store our data the result from looping
    ...
    fun listDzikirPagi (): List<DoaDzikirItem> {
        val listDzikir= arrayListOf<DoaDzikirItem>()
    ...
    private val terjemahDzikirPetang = arrayOf(
     ...
     fun listDzikirPetang (): List<DoaDzikirItem> {
        ...
        for (i in titleDzikirPetang.indices) {
            val data = DoaDzikirItem(
                titleDzikirPetang[i],
                lafazDzikirPetang[i],
